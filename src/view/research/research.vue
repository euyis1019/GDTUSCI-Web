    ...
    <div class="insights">
        <div class="insightsItem">
            <div class="insightsText">
                ...
                <p @click="$router.push('/researchA')">Design Application of Concrete Materials Exploration and Practice
                    of Materials</p>
                <h6>2024-01</h6>
            </div>
        ...
        <div class="insightsItem">
            <div class="insightsText">
                <h5>材料的探索与实践_混凝土材料的设计应用</h5>
                <p @click="$router.push('/researchB')">Design Application of Concrete Materials Exploration and Practice
                    of Materials</p>
                <h6>2024-01</h6>
            </div>
        ...
        <div class="insightsItem">
            <div class="insightsText">
                <h5>材料的探索与实践_混凝土材料的设计应用</h5>
                <p @click="$router.push('/researchC')">Design Application of Concrete Materials Exploration and Practice
                    of Materials</p>
                <h6>2024-01</h6>
            </div>
...
.insights-img-self:hover,
.insightsText:hover+.insightsImg .insights-img-self {
    transform: scale(1.1);
}
